...
import scrapy
from guardian_scraper.items import Article
from guardian_scraper.spiders.providers.spider_config_provider import SpiderConfigProvider
...
class GuardianSpider(scrapy.Spider):
    ...
    def parsearticle(self, response, _spider_config_provider):
        ...
        item['_id'] = str(uuid.uuid5(uuid.NAMESPACE_URL, response.request.url))
